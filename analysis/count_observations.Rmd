...
---
<font size = "4">Count the number of bgc-argo observations, and plot the evolution over time</font> 

Use the same process as in loading_data.html to load in bgc-argo data and the corresponding metadata: 
