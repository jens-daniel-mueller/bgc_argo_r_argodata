...
# Read chl-a data'
overlay_va <- read_rds(file = paste0(path_argo_preprocessed, "/chla_bgc_va.rds")) %>%
  select (file_id,
          date,
          year,
          month,
...
if (opt_category == "bgc_ph_ph"){
  overlay_factor <- 25
  overlay_offset <- 1
  overlay_factor_adjusted <- 1
  overlay_offset_adjusted <- 0.5
...
overlay_color <- "#69b3a2"
opt_overlay_measure_label <- opt_chla_measure_label
