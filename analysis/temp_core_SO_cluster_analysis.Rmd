---
title: "SO core temperature cluster analysis"
...
A restriction is added that just SO profiles are considered
...
temp_anomaly_va.rds - core preprocessed folder, created by temp_align_climatology

OceanSODA_SST_anomaly_field_01.rds (or _02.rds) - bgc preprocessed folder, created by extreme_temp
...
if (opt_category == "core_temp_SO") {
  ...
  anomaly_va <-
    read_rds(file = paste0(path_core_preprocessed, "/temp_anomaly_va.rds")) %>%
