...
# 604 150 occurrences of flag 1 
# 1841 occurrences of flag 4 
# 568 356 occurrences of flag 8 
# table(bgc_merge_pH_qc_1$ph_in_situ_total_adjusted_qc)
# 1 219 410 occurrences of qc flag 1 (all obs)
# 1 219 410 total observations 
...
# 567 327 total observations 

# table((bgc_merge_flag_A$profile_ph_in_situ_total_qc))
# table(bgc_merge_flag_A$profile_temp_qc)
 
# table(bgc_merge_flag_A$temp_adjusted_qc)
# 389 436 occurrences of flag 1
# 177 891 occurrences of flag 8
# table(is.na(bgc_merge_flag_A$temp_adjusted))
# no NA temperature values 
# table(bgc_merge_flag_A$ph_in_situ_total_adjusted_qc)
# 567 217 occurrences of flag 1 
# 110 occurrences of flag 8 


bgc_merge_flag_A %>% 
  write_rds(file = paste0(path_argo_preprocessed, "/bgc_merge_flag_A.rds"))

# bgc_merge_flag_A <- bgc_merge_flag_A %>% 
#   filter(!is.na(temp_adjusted),
...
# 567 217 occurrences of flag 1 
# 110 occurrences of flag 8 
#table(round(bgc_merge_flag_A$depth, digits = 0))
...
#table(bgc_merge_qc_1$ph_in_situ_total_adjusted_qc)
...
# Argo temperature climatology 

## CSIO-MNR temperature climatology
...
## Roemmich-Gilson UCSD temperature climatology 
...
```{r join_annual_and_monthly_clim}
