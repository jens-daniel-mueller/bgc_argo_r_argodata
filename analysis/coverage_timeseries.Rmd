...
path_argo_core_preprocessed <- paste0(path_argo_core, 
                                      "/preprocessed_core_data")
...
```{r plot_core_profile_counts, fig.asp=0.5}
...
```{r count_A_flag_core_profiles, fig.asp=0.5}
...
```{r core_temp_profiles_flag_A_timeseries, fig.asp=0.5}
...
```{r count_core_profiles_by_region, fig.asp=0.5}
