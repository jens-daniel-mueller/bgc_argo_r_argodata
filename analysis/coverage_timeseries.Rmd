...
# count the number of profiles which contain all three parameters with a QC flag of A 
...
bgc_profile_counts_total_A %>% 
  ...
  facet_grid(. ~ year,
             scales = "free_y") +
  scale_x_continuous(breaks = seq(1,12,2)) +
  labs(x = 'month', y = 'number of profiles', title = 'number of oxygen, pH, and nitrate profiles')+
  theme_bw()
