...
```{r climatological_oxygen_map_nwpacific}
...
map +
  ...
  lims(y = c(5, 60), 
       x = c(180, 250)) +
  scale_fill_gradientn(colors = oceColorsJet(n = oxy_mean_hawaii$oxy_ave_month)) +
  labs(x = 'lon',
       y = 'lat',
       fill = 'dissolved oxygen \n(µmol kg-1)',
