...
---
<font size = "4"> Map the location of oxygen, pH, and nitrate observations recorded by BGC-Argo floats</font> 

```{r loading_packages}

library(tidyverse, quietly = TRUE)
# remotes::install_github("ArgoCanada/argodata")
library(argodata, quietly = TRUE)
library(argoFloats, quietly = TRUE)
