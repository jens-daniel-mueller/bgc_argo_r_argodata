...
path_argo_core <- "/nfs/kryo/work/datasets/ungridded/3d/ocean/floats/core_argo_r_argodata" #core_argo_r_argodata_2024-03-13
...
# argo package: https://rdrr.io/github/ArgoCanada/argodata/man/
...
if (!opt_qc_only) {
  ...
  if (opt_refresh_cache){
    ...
    argo_update_global(max_global_cache_age = -Inf)  #-72*24
