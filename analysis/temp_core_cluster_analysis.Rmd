...
In addition the cluster analysis is repeated under under surface extremes conditions.
...
opt_n_start <- 15
opt_max_iterations <- 100 # given size of data set reduce this to 100
