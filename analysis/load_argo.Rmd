...
opt_refresh_years_doxy = 1
opt_refresh_years_nitrate = 1
opt_refresh_years_pH = 1
...
opt_consolidate_psal = 1
opt_consolidate_doxy = 1
opt_consolidate_nitrate = 1
opt_consolidate_pH = 1
opt_consolidate_metadata = 1

# opt_summary_files
# consolidated files must have already been created!
#   0 = do not build summary files from previously written consolidated files. (any value <> 1 will omit A and AB files)
#   1 = build summary files from previously written consolidated files.
opt_summary_files = 1
...
```{r test_flag_A_without_removing_NA}
