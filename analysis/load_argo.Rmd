...
bgc_merge_pH_qc_1.rds

bgc_merge_temp_qc_1.rds

bgc_merge_temp_AB.rds

bgc_merge_flag_AB.rds
...
if (!opt_qc_only) {
  ...
  #                                 2023 the process would halt part way through and not continue.
  ...
  argo_set_mirror("ftp://ftp.ifremer.fr/ifremer/argo")
  argo_mirror()
...
```{r create_flag_A_bgc_argo_dataframe}
...
# bgc_metadata["profile_chla_qc"][is.na(bgc_metadata["profile_chla_qc"])] <- ""
