...
```{r overall_mean_anomaly_profiles_broullon}
...
remove_clim_biome %>% 
  ...
  geom_vline(xintercept = 0)+
  scale_y_continuous(trans = trans_reverser('sqrt'),
                     breaks = c(10, 100, 250, seq(1000, 5000, 500)))+
  facet_grid(season~biome_name)+
  scale_color_manual(values = HNL_colors)+
  scale_fill_manual(values = HNL_colors)+
...
```{r basin_mean_anomaly_profiles_broullon}
