...
```{r biomes_flat_map_pre_grid_reduction}
...
```{r biomes_flat_map_post_grid_reduction}
...
```{r basin_flat_map_pre_grid_reduction}
map +
...
```{r basin_flat_map_post_grid_reduction}
...
```{r map_regression_slopes_flat, fig.asp=2}
