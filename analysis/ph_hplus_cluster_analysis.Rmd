---
title: "ph (h plus) cluster analysis"
...
This markdown file carries out cluster analysis on previously created bgc ph anomaly profiles.
...
cluster_analysis_extreme.Rmd - In addition the cluster analysis under under surface extremes conditions.

ph is displayed on [H+] scale
...
if (opt_category == "bgc_ph_h_plus") {
  ...
  # nitrate formatting
  opt_nitrate_measure_label <- expression("nitrate anomaly ( µmol kg"^"-1"~")")
