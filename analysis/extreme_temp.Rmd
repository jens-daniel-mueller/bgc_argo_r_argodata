...
# keep data on the original 2x2 grid 
```
...
OceanSODA_temp_SO <- OceanSODA_temp_SO %>% 
...
OceanSODA_temp_regression <- OceanSODA_temp_SO %>% 
...
OceanSODA_temp_regression_augmented <- bind_cols(
  ...
  OceanSODA_temp_regression_data %>% 
    select(date, row_number, biome, basin_AIP))
...
```{r flat_map_temp_extremes_1x1_plot, fig.asp=2, eval=FALSE}
