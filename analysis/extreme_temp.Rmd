...
# original 1x1:
# OceanSODA_temp_SO <- inner_join(OceanSODA_temp, region_masks_all_2x2)
...
OceanSODA_temp_2x2_SO_extreme_grid_2017 <- OceanSODA_temp_2x2_SO_extreme_grid %>% 
  filter(date == '2017-10-15')  

map+
  geom_tile(data = OceanSODA_temp_2x2_SO_extreme_grid_2017,
            aes(x = lon,
                y = lat,
                fill = temp_extreme))+
  scale_fill_manual(values = HNL_colors_map)+
