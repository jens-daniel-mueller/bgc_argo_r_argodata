...
```{r biomes_map_pre_grid_reduction, fig.asp=0.5}
...
```{r biomes_map_post_grid_reduction, fig.asp=0.5}
...
```{r basin_map_pre_grid_reduction, fig.asp=0.5}
map +
...
```{r basin_map_post_grid_reduction, fig.asp=0.5}
...
```{r map_OceanSODA_clim_diff, fig.asp=2}
...
```{r map_temp_extremes_1x1_plot, fig.asp=2}
...
```{r plot_basin_biome_mean_anomaly_profiles}
