...
basemap(limits = -30, data = ph_mean) +   # change to polar projection 
  geom_spatial_tile(data = ph_mean, 
            aes(x = lon,
                y = lat,
                fill = ph_ave_month),
            linejoin = 'bevel')+
  ...
  labs(x = 'lon',
       ...
       title = 'monthly average pH (Apr 2014 - Aug 2021)')+
  facet_wrap(~month)
# the squares look grey but it's because I haven't figured out how to remove the borders
```
