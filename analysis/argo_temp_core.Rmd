---
title: "Core-Argo Temperature Data"
...
temp_bgc_observed.rds - core preprocessed folder, created by temp_core_align_climatology. Not this file is written BEFORE the vertical alignment stage.
...
Map of monthly climatological Argo temperature (core-Argo floats, flag A profiles only), January 2013-April 2022
(January 1st - February 1st 2013 only for test purposes)

```{r monthly_clim_core_sst_maps, fig.asp=2}
...
```{r using_ggOceanMaps_core_sst, fig.asp=2, eval=FALSE}
...
```{r plot_monthly_core_sst_timeseries}
...
```{r plot_monthly_sst_core_per_year}
